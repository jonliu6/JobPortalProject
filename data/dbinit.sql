...
DROP DATABASE IF EXISTS jobportaldb;
...
CREATE USER 'jobportal'@'localhost' IDENTIFIED BY 'jobportal_2K';

GRANT ALL PRIVILEGES ON jobportaldb.* TO 'jobportal'@'localhost';
